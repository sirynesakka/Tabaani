...
const Essai = () => {
  ...
  <h2 class="block antialiased tracking-normal font-sans text-4xl font-semibold font-serif leading-[1.3] text-center text-blue-gray-900 !text-3xl !leading-snug lg:!text-4xl">Tabaani </h2>
  ...
  <div class="mt-10 grid grid-cols-1 gap-10 lg:grid-cols-3">
    <div class="relative flex flex-col bg-clip-border rounded-xl bg-transparent text-gray-700 shadow-md relative grid min-h-[30rem] items-end overflow-hidden rounded-xl"><img src="mm.jpg" alt="bg" class="absolute inset-0 h-full w-full object-cover object-center" />
      ...
      <div class="p-6 relative flex flex-col justify-end">
        <h4 class="block antialiased tracking-normal font-sans text-2xl font-semibold font-serif leading-snug text-black">Tabaani</h4>
        <p class="block antialiased font-sans text-base  leading-relaxed text-black my-2 font-serif"> Si vous êtes indécis sur où aller manger et que vous manquez de recommandations, notre application Tabaani peut vous aider à trouver la solution..</p>
      </div>
    </div>
    ...
    <div class="relative flex flex-col bg-clip-border rounded-xl bg-transparent text-gray-700 shadow-md relative grid min-h-[30rem] items-end overflow-hidden rounded-xl"><img src="mm3.jpg" alt="bg" class="absolute inset-0 h-full w-full object-cover object-center" />
      <div class="absolute inset-0 bg-green-50/70"></div>
      <div class="p-6 relative flex flex-col justify-end">
        <h4 class="block antialiased tracking-normal font-sans text-2xl font-semibold font-serif leading-snug text-black">Les avis </h4>
        <p class="block antialiased font-sans text-base font-serif leading-relaxed text-black my-2 font-normal"> Partagez vos avis sur notre site pour aider les autres à choisir les meilleures adresses. Votre expérience compte ! En laissant votre avis, vous contribuez à guider les autres dans leurs choix.</p>
      </div>
    </div>
  </div>
</section>
