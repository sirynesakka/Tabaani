...
export async function POST(request) {
    ...
    const deleteReason = formData.get('deleteReason');
        ...
        const mail = await transporter.sendMail({
            ...
            html: `
                <div style="font-family: 'Times New Roman', Times, serif; max-width: 600px; margin: 0 auto;">
                    ...
                    <p style="font-size: 16px; line-height: 1.5; color: #000; font-weight: bold; font-style: italic;">Je suis désolé(e) de vous informer que votre Publication a été <span style="color: red; font-weight: bold; font-style: italic;">Supprimer</span>.</p> pour la raison suivante : ${deleteReason}.</p>
