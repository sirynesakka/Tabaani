...
const StyledInput2 = ({ label,type, name, defaultValue, placeholder, register, required, pattern, message ,errors}) => {
  return (
    <div className="col-span-full">
      <label
        htmlFor={name}
        className="mb-2 block mb-2 text-sm font-serif font-semibold text-gray-700 underline"
      >
        {label}
      </label>
      <div className="mt-2">
        ...
        type={type}
          ...
          {...register(name, { required, pattern: pattern && { value: pattern, message: message } })}
