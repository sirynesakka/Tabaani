...
const Dateinput = ({  name, defaultValue, placeholder, register, required, pattern, message ,errors}) => {
  return (
    <div className="col-span-full">
      ...
      <div className="mt-2">
        ...
        type='date'
          ...
          {...register(name, { required,valueAsDate: true, pattern: pattern && { value: pattern, message: message } })}
